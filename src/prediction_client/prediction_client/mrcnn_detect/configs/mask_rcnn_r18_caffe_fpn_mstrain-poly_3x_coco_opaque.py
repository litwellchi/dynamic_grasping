_base_ = '/home/xwchi/autostore_phase1/mmdetection/configs/mask_rcnn/mask_rcnn_r18_caffe_fpn_mstrain-poly_1x_coco.py'
# learning policy
...
dataset_train_A = dict(
        ...
        img_prefix='/home/xwchi/autostore_phase1/phase1_data/',
        pipeline=train_pipeline,
        classes = ('object',))
dataset_train_B = dict(
        type=dataset_type,
        ann_file='/home/xjgao/Dataset/Autostore/realdata/Desktop/mix/0/dataset.json',
        img_prefix='/home/xwchi/autostore_phase1/phase1_data/mix/',
        pipeline=train_pipeline,
        classes = ('object',))
...
data = dict(
    train=[dataset_train_A, dataset_train_B, dataset_train_C, dataset_train_D, dataset_train_E, dataset_train_A_origin, dataset_train_C_origin, dataset_train_D_origin, dataset_train_E_origin],
    # train=[dataset_train_A_origin, dataset_train_C_origin, dataset_train_D_origin, dataset_train_E_origin],
    val=[dataset_val_origin,dataset_val_origin]
    )